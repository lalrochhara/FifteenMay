...
#print(flag)
log = logging.getLogger('[FifteenMay]')
logging.getLogger('ptbcontrib.postgres_persistence.postgrespersistence').setLevel(logging.WARNING)
log.info("[FifteenMay] FifteenMay is starting. | An Famhawite Infosys Project. | Licensed under GPLv3.")
log.info("[FifteenMay] Not affiliated to Azur Lane or Yostar in any way whatsoever.")
log.info("[FifteenMay] Project maintained by: github.com/lalrochhara (t.me/NickyLrca)")

# if version < 3.6, stop bot.
if sys.version_info[0] < 3 or sys.version_info[1] < 7:
    log.error(
        "[FifteenMay] You MUST have a python version of at least 3.7! Multiple features depend on this. Bot quitting."
    )
    quit(1)

parser = ConfigParser()
parser.read("config.ini")
FifteenMayconfig = parser["FifteenMayconfig"]

class FifteenMayINIT:
    def __init__(self, parser: ConfigParser):
        ...
        self.bot_name = "FifteenMay" #placeholder
        self.bot_username = "FifteenMayBot" #placeholder
...
FifteenMayInit = FifteenMayINIT(parser=FifteenMayconfig)

SYS_ADMIN = FifteenMayInit.SYS_ADMIN
OWNER_ID = FifteenMayInit.OWNER_ID
OWNER_USERNAME = FifteenMayInit.OWNER_USERNAME
APP_ID = FifteenMayInit.APP_ID
API_HASH = FifteenMayInit.API_HASH
WEBHOOK = FifteenMayInit.WEBHOOK
URL = FifteenMayInit.URL
CERT_PATH = FifteenMayInit.CERT_PATH
PORT = FifteenMayInit.PORT
INFOPIC = FifteenMayInit.INFOPIC
DEL_CMDS = FifteenMayInit.DEL_CMDS
ALLOW_EXCL = FifteenMayInit.ALLOW_EXCL
CUSTOM_CMD = FifteenMayInit.CUSTOM_CMD
BAN_STICKER = FifteenMayInit.BAN_STICKER
TOKEN = FifteenMayInit.TOKEN
DB_URI = FifteenMayInit.DB_URI
LOAD = FifteenMayInit.LOAD
MESSAGE_DUMP = FifteenMayInit.MESSAGE_DUMP
GBAN_LOGS = FifteenMayInit.GBAN_LOGS
NO_LOAD = FifteenMayInit.NO_LOAD
...
spamwatch_api = FifteenMayInit.spamwatch_api
CASH_API_KEY = FifteenMayInit.CASH_API_KEY
TIME_API_KEY = FifteenMayInit.TIME_API_KEY
WALL_API = FifteenMayInit.WALL_API
LASTFM_API_KEY = FifteenMayInit.LASTFM_API_KEY
CF_API_KEY = FifteenMayInit.CF_API_KEY

# SpamWatch
sw = FifteenMayInit.init_sw()


updater = tg.Updater(token=TOKEN, base_url=FifteenMayInit.BOT_API_URL, base_file_url=FifteenMayInit.BOT_API_FILE_URL, workers=min(32, os.cpu_count() + 4), request_kwargs={"read_timeout": 10, "connect_timeout": 10})
...
from FifteenMay.modules.helper_funcs.handlers import CustomCommandHandler
