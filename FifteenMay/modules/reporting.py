...
from FifteenMay import log, SUDO_USERS, SARDEGNA_USERS, WHITELIST_USERS
...
from FifteenMay.modules.sql import reporting_sql as sql
...
@FifteenMay(command='report', filters=Filters.chat_type.groups, group=REPORT_GROUP)
@FifteenMay((Filters.regex(r"(?i)@admin(s)?")), group=REPORT_GROUP)
@user_not_admin
@loggable
