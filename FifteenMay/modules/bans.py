...
from FifteenMay.modules.helper_funcs.extraction import extract_user_and_text
from FifteenMay.modules.helper_funcs.string_handling import extract_time
from FifteenMay.modules.log_channel import loggable, gloggable
from FifteenMay.modules.helper_funcs.decorators import FifteenMay

from ..modules.helper_funcs.anonymous import user_admin, AdminPerms


@FifteenMay(command='ban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
...
def ban(update: Update, context: CallbackContext) -> Optional[str]:  # sourcery no-metrics
    ...
    if is_user_ban_protected(update, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            ...
            message.reply_text("Bring an order from Famhawite Infosys to fight a Sardegna.")
...
@FifteenMay(command='tban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@FifteenMay(command='kick', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@FifteenMay(command='kickme', pass_args=True, filters=Filters.chat_type.groups)
@bot_admin
@can_restrict
...
@FifteenMay(command='unban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@FifteenMay(command='selfunban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@gloggable
