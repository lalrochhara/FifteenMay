...
from FifteenMay import FifteenMayInit, dispatcher, DEV_USERS, OWNER_ID, log
...
def error_callback(update: Update, context: CallbackContext):
    ...
    if e.find(FifteenMayInit.TOKEN) != -1:
        e = e.replace(FifteenMayInit.TOKEN, "TOKEN")

    if update.effective_chat.type != "channel" and FifteenMayInit.DEBUG:
        try:
