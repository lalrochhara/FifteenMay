...
import FifteenMay.modules.sql.locks_sql as sql
from FifteenMay import dispatcher, log
...
@FifteenMay(command='lock', pass_args=True)
...
@FifteenMay(command='unlock', pass_args=True)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
@typing_action
...
@FifteenMay((Filters.all & Filters.chat_type.groups), group=PERM_GROUP)
@user_not_admin
