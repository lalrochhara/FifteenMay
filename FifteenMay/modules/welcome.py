...
import FifteenMay.modules.sql.welcome_sql as sql
...
from FifteenMay.modules.helper_funcs.msg_types import get_welcome_type
from FifteenMay.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from FifteenMay.modules.log_channel import loggable
from FifteenMay.modules.sql.antispam_sql import is_user_gbanned
...
import FifteenMay.modules.sql.log_channel_sql as logsql
...
def new_member(update: Update, context: CallbackContext):  # sourcery no-metrics
    ...
    if should_welc:
        ...
        # Welcome Devs
            ...
            bot.send_message(chat.id,
                "Whoa! A member of the Famhawite Infosys just joined!",
            )
            return
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            # Give the devs a special goodbye
                ...
                bot.send_message(chat.id,
                    "See you later at the Famhawite Infosys!",
                )
                return
