...
from FifteenMay import LASTFM_API_KEY
from FifteenMay.modules.helper_funcs.decorators import FifteenMay
import FifteenMay.modules.sql.last_fm_sql as sql

@FifteenMay(command='setuser')
