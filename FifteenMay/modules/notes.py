...
from FifteenMay import log, dispatcher, SUDO_USERS
from FifteenMay.modules.helper_funcs.chat_status import connection_status
from FifteenMay.modules.helper_funcs.misc import build_keyboard, revert_buttons
from FifteenMay.modules.helper_funcs.msg_types import get_note_type
from FifteenMay.modules.helper_funcs.handlers import MessageHandlerChecker
from FifteenMay.modules.helper_funcs.string_handling import escape_invalid_curly_brackets
...
@FifteenMay((Filters.regex(r"^#[^\s]+")), group=-14)
@connection_status
...
@FifteenMay((Filters.regex(r"^/\d+$")), group=-16)
@connection_status
...
@FifteenMay(command='removeallnotes')
...
@FifteenMay(command=["notes", "saved"])
@connection_status
