...
import FifteenMay.modules.sql.userinfo_sql as sql
from FifteenMay import SUDO_USERS, DEV_USERS
...
@FifteenMay(command='me', pass_args=True)
...
@FifteenMay(command='bio', pass_args=True)
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text("Erm... yeah, I only trust Famhawite Infosys to set my bio.")
            return
