...
import FifteenMay.modules.sql.blacklistusers_sql as sql
...
from FifteenMay.modules.helper_funcs.chat_status import dev_plus
...
@FifteenMay(command='ignore', pass_args=True)
@dev_plus
@gloggable
...
@FifteenMay(command='notice', pass_args=True)
@dev_plus
@gloggable
...
@FifteenMay(command='ignoredlist', pass_args=True)
@dev_plus
