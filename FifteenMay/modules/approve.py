...
import FifteenMay.modules.sql.approve_sql as sql
from FifteenMay import SUDO_USERS
from FifteenMay.modules.helper_funcs.chat_status import user_admin as u_admin
...
@FifteenMay(command='approve', filters=Filters.chat_type.groups)
@loggable
...
@FifteenMay(command='unapprove', filters=Filters.chat_type.groups)
@loggable
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@FifteenMay(command='approved', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@FifteenMay(command='approval', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@FifteenMay(command='unapproveall', filters=Filters.chat_type.groups)
...
@FifteenMay(pattern=r"unapproveall_.*")
