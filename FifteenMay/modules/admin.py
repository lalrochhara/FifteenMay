...
@FifteenMay(command="promote", can_disable=False)
@connection_status
@bot_admin
@can_promote
...
@FifteenMay(command="demote", can_disable=False)
@connection_status
@bot_admin
@can_promote
@user_admin(AdminPerms.CAN_PROMOTE_MEMBERS)
...
"""
@FifteenMay(command="admincache", can_disable=False)
@u_admin
...
@FifteenMay(command="title", can_disable=False)
@connection_status
@bot_admin
@can_promote
@user_admin(AdminPerms.CAN_PROMOTE_MEMBERS)
...
@FifteenMay(command="pin", can_disable=False)
@bot_admin
@can_pin
...
@FifteenMay(command="unpin", can_disable=False)
@bot_admin
@can_pin
@user_admin(AdminPerms.CAN_PIN_MESSAGES)
@loggable
...
@FifteenMay(command="invitelink", can_disable=False)
@bot_admin
...
@FifteenMay(command=["admin", "admins"])
