...
import FifteenMay.modules.sql.antispam_sql as gban_sql
import FifteenMay.modules.sql.users_sql as user_sql
from FifteenMay import DEV_USERS, OWNER_ID, dispatcher
