...
from FifteenMay.modules.sql.approve_sql import is_approved
import FifteenMay.modules.sql.blacklist_sql as sql
from FifteenMay import log, dispatcher
from FifteenMay.modules.helper_funcs.chat_status import user_admin as u_admin, user_not_admin
from FifteenMay.modules.helper_funcs.extraction import extract_text
from FifteenMay.modules.helper_funcs.misc import split_message
from FifteenMay.modules.log_channel import loggable
from FifteenMay.modules.warns import warn
from FifteenMay.modules.helper_funcs.string_handling import extract_time
from FifteenMay.modules.connection import connected
from FifteenMay.modules.helper_funcs.decorators import FifteenMay, FifteenMay
from FifteenMay.modules.helper_funcs.alternate import send_message, typing_action

from ..modules.helper_funcs.anonymous import user_admin, AdminPerms

BLACKLIST_GROUP = -3

@FifteenMay(command="blacklist", pass_args=True, admin_ok=True)
@u_admin
@typing_action
...
@FifteenMay(command="addblacklist", pass_args=True)
...
@FifteenMay(command="unblacklist", pass_args=True)
@user_admin(AdminPerms.CAN_DELETE_MESSAGES)
@typing_action
...
@FifteenMay(command="blacklistmode", pass_args=True)
@loggable
...
@FifteenMay(((Filters.text | Filters.command | Filters.sticker | Filters.photo) & Filters.chat_type.groups), group=BLACKLIST_GROUP)
@user_not_admin
