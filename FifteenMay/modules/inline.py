...
from FifteenMay.modules.helper_funcs.misc import article
from FifteenMay.modules.helper_funcs.decorators import FifteenMayinline
...
def inlinequery(update: Update, _) -> None:
    ...
    if (f := query.split(" ", 1)[0]) in inline_funcs:
        ...
        inline_help_dicts = [
            ...
            #},
            {
                "title": "Account info on FifteenMay",
                "description": "Look up a Telegram account in FifteenMay database",
                "message_text": "Click the button below to look up a person in FifteenMay database using their Telegram ID",
                "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
                "keyboard": ".info ",
            },
            {
                "title": "About",
                "description": "Know about FifteenMay",
                "message_text": "Click the button below to get to know about FifteenMay.",
                "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
                "keyboard": ".about ",
            },
            {
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    sql.update_user(user.id, user.username)
    about_text = f"""
    FifteenMay (@{context.bot.username})
    Maintained by [Nicky Lalrochhar](t.me/nickylrca)
    Built with ❤️ using python-telegram-bot v{str(__version__)}
    Running on Python {python_version()}
    """
    results: list = []
    kb = InlineKeyboardMarkup([[InlineKeyboardButton(text="Support", url="https://t.me/YorktownEagleUnion"), InlineKeyboardButton(text="Channel", url="https://t.me/FifteenMayUpdates"), InlineKeyboardButton(text='Ping', callback_data='pingCB')], [InlineKeyboardButton(text="GitLab", url="https://www.gitlab.com/lalrochhara/FifteenMay"), InlineKeyboardButton(text="GitHub", url="https://github.com/lalrochhara/FifteenMay/",)]])
    ...
    results.append(
        ...
        InlineQueryResultArticle
            (
            id=str(uuid4()),
            title=f"About FifteenMay (@{context.bot.username})",
