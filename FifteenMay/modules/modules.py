...
from FifteenMay.__main__ import (
    CHAT_SETTINGS,
    DATA_EXPORT,
    DATA_IMPORT,
    HELPABLE,
...
from FifteenMay.modules.helper_funcs.chat_status import dev_plus, sudo_plus
from telegram import ParseMode, Update
from telegram.ext import CallbackContext
from FifteenMay.modules.helper_funcs.decorators import FifteenMay


@FifteenMay(command='load')
@dev_plus
def load(update: Update, context: CallbackContext):
    ...
    try:
        imported_module = importlib.import_module("FifteenMay.modules." + text)
    except:
...
@FifteenMay(command='listmodules')
@sudo_plus
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("FifteenMay.modules.", 1)[1]
