...
import FifteenMay.modules.sql.language_sql as sql
from FifteenMay.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from FifteenMay.langs import get_string, get_languages, get_language
    ...
    keyb.append(
        [
            InlineKeyboardButton(
                ...
                url="https://localazy.com/p/15-may-translations-project",
            )
        ]
    )
