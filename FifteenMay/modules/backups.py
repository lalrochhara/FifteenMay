...
import FifteenMay.modules.sql.notes_sql as sql
from FifteenMay import dispatcher, log as LOGGER, OWNER_ID
from FifteenMay.__main__ import DATA_IMPORT
from FifteenMay.modules.helper_funcs.alternate import typing_action
from FifteenMay.modules.helper_funcs.decorators import FifteenMay
# from FifteenMay.modules.rules import get_rules
import FifteenMay.modules.sql.rules_sql as rulessql
from FifteenMay.modules.language import gs
# from FifteenMay.modules.sql import warns_sql as warnssql
import FifteenMay.modules.sql.blacklist_sql as blacklistsql
from FifteenMay.modules.sql import disable_sql as disabledsql

# from FifteenMay.modules.sql import cust_filters_sql as filtersql
# import FifteenMay.modules.sql.welcome_sql as welcsql
import FifteenMay.modules.sql.locks_sql as locksql
...
def export_data(update, context):  # sourcery no-metrics
    ...
    with open("FifteenMayBot{}.json".format(chat_id), "w") as f:
        f.write(str(baccinfo))
    context.bot.sendChatAction(current_chat_id, "upload_document")
    tgl = time.strftime("%H:%M:%S - %d/%m/%Y", time.localtime(time.time()))
    context.bot.sendDocument(
        current_chat_id,
        document=open("FifteenMayBot{}.json".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `FifteenMayBot-Backup` was specially made for notes.".format(
    ...
    os.remove("FifteenMayBot{}.json".format(chat_id))  # Cleaning file
