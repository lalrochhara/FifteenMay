...
from FifteenMay import dispatcher, log, SUDO_USERS
from FifteenMay.modules.helper_funcs.extraction import extract_text
from FifteenMay.modules.helper_funcs.filters import CustomFilters
from FifteenMay.modules.helper_funcs.misc import build_keyboard_parser
from FifteenMay.modules.helper_funcs.msg_types import get_filter_type
from FifteenMay.modules.helper_funcs.string_handling import (
    split_quotes,
    button_markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
)
from FifteenMay.modules.sql import cust_filters_sql as sql
...
@typing_action
@FifteenMay(command='filters', admin_ok=True)
...
@FifteenMay(command='filter', run_async=False)
...
# NOT ASYNC BECAUSE DISPATCHER HANDLER RAISED
@FifteenMay(command='stop', run_async=False)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@typing_action
...
@FifteenMay((CustomFilters.has_text & ~Filters.update.edited_message))
...
@FifteenMay(command="removeallfilters", filters=Filters.chat_type.groups)
