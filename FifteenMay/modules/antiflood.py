...
from FifteenMay import SARDEGNA_USERS, WHITELIST_USERS, dispatcher
from FifteenMay.modules.sql.approve_sql import is_approved
from FifteenMay.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    connection_status,
    is_user_admin,
...
from FifteenMay.modules.sql import antiflood_sql as sql
...
from FifteenMay import dispatcher
...
from FifteenMay.modules.helper_funcs.alternate import send_message
...
@FifteenMay((Filters.all & ~Filters.status_update & Filters.chat_type.groups), group=FLOOD_GROUP)
@connection_status
@loggable
...
@user_admin_no_reply
@bot_admin
@FifteenMay(pattern=r"unmute_flooder")
...
@FifteenMay(command='setflood', pass_args=True, filters=Filters.chat_type.groups)
@connection_status
...
@FifteenMay(command="flood", filters=Filters.chat_type.groups)
@connection_status
...
@FifteenMay(command="setfloodmode", pass_args=True, filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
