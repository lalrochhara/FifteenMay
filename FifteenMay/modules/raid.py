...
from .helper_funcs.decorators import FifteenMay, FifteenMay
...
@FifteenMay(command="raid", pass_args=True)
@bot_admin
@connection_status
@loggable
...
@FifteenMay(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@FifteenMay(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@FifteenMay(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@FifteenMay(command="raidactiontime", pass_args=True)
@connection_status
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
