...
from FifteenMay.modules.helper_funcs.chat_status import is_user_admin
from FifteenMay.modules.helper_funcs.extraction import (
    extract_user,
    extract_unt_fedban,
    extract_user_fban,
)
from FifteenMay.modules.helper_funcs.string_handling import markdown_parser

import FifteenMay.modules.sql.feds_sql as sql

from FifteenMay.modules.helper_funcs.alternate import (
    send_message,
    typing_action,
    send_action,
)
from FifteenMay.modules.helper_funcs.decorators import FifteenMay, FifteenMay
...
@typing_action
@FifteenMay(command='delfed', pass_args=True)
...
@typing_action
@FifteenMay(command='chatfed', pass_args=True)
...
@typing_action
@FifteenMay(command='joinfed', pass_args=True)
...
@typing_action
@FifteenMay(command='fpromote', pass_args=True)
...
@typing_action
@FifteenMay(command='fdemote', pass_args=True)
...
@typing_action
@FifteenMay(command='fedinfo', pass_args=True)
...
@typing_action
@FifteenMay(command='fedadmins', pass_args=True)
...
@typing_action
@FifteenMay(command=['fban', 'fedban'], pass_args=True)
...
@typing_action
@FifteenMay(command=['unfban', 'rmfedban'], pass_args=True)
...
@typing_action
@FifteenMay(command='frules', pass_args=True)
...
@typing_action
@FifteenMay(command='fbroadcast', pass_args=True)
...
@FifteenMay(command='fbanlist', pass_args=True, pass_chat_data=True)
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "FifteenMay_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="FifteenMay_fbanned_users.json",
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "FifteenMay_fbanned_users.csv"
                update.effective_message.reply_document(
                    document=output,
                    filename="FifteenMay_fbanned_users.csv",
...
@typing_action
@FifteenMay(command='fednotif', pass_args=True)
...
@typing_action
@FifteenMay(command='fedchats', pass_args=True)
...
@typing_action
@FifteenMay(command='importfbans', pass_args=True, pass_chat_data=True)
...
@typing_action
@FifteenMay(command='fbanstat', pass_args=True)
...
@typing_action
@FifteenMay(command='setfedlog', pass_args=True)
...
@typing_action
@FifteenMay(command='unsetfedlog', pass_args=True)
...
@typing_action
@FifteenMay('subfed', pass_args=True)
...
@typing_action
@FifteenMay(command='unsubfed', pass_args=True)
...
@typing_action
@FifteenMay(command='fedsubs', pass_args=True)
...
@typing_action
@FifteenMay(command='myfeds', pass_args=True)
...
@FifteenMay(pattern=r"fed_help_")
